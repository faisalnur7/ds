...
<a
    ...
    @class([
        'bg-cyan-400/10 text-cyan-200 ring-1 ring-inset ring-cyan-400/20' => $active,
        'text-slate-300 hover:bg-white/5 hover:text-white' => ! $active,
    ])
>
    <span @class([
        'h-2.5 w-2.5 rounded-full bg-cyan-300 shadow-[0_0_0_4px_rgba(34,211,238,0.15)]' => $active,
