...
@section('content')
    <div class="rounded-3xl border border-white/10 bg-slate-900/80 p-6 shadow-2xl shadow-black/20 backdrop-blur">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <h2 class="font-[family-name:Space_Grotesk] text-2xl font-bold text-white">Users</h2>
                <p class="mt-1 text-sm text-slate-400">Manage accounts from a clean, responsive table.</p>
            </div>
